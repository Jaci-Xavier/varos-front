...
function CardHero() {
  return (
    <div className='w-[325px] h-[371px] top-[269px] left-[870px] rounded-2xl flex flex-col justify-around mt-[150px] ml-8'>
      ...
      <div className='flex flex-row items-center text-center gap-[11px] p-2'>
        ...
        <a>Código<span className='text-[#00F0C9]'>.py</span></a>
      </div>
    </div>
  )
}
